...
L.MSG_INVALID_SOUND_FILE			= "효과음은 .mp3 혹은 .wav 파일이어야 합니다."
...
obj["hyperRegen"]				= { label="고속 회복", tooltip="고속 회복 능력(환기나 정신력 누출과 같은) 효과에 의한 마력 (마나, 분노, 기력, 룬 마력) 회득을 표시합니다.\n\n주의: 이 마력 획득의 출력시간은 조정할수 없습니다."}
...
obj["INCOMING_SPELL_MISS"]					= { label="주문 빗맞힘", tooltip="자신에게 적중하지 않은 주문 공격을 활성화합니다."}
...
obj["PET_INCOMING_SPELL_MISS"]					= { label="주문 공격 실패", tooltip="소환수에게 적중하지 않은 주문 공격을 활성화합니다."}
...
obj["OUTGOING_SPELL_MISS"]					= { label="주문 빗맞힘", tooltip="대상에게 적중하지 않은 주문 공격을 활성화합니다."}
...
obj["PET_OUTGOING_SPELL_MISS"]					= { label="주문 빗맞힘", tooltip="대상에게 적중하지 않은 소환수의 주문 공격을 활성화합니다."}
...
obj["PET_OUTGOING_SPELL_EVADE"]					= { label="주문 빗나감", tooltip="대상에게 빗나간 소환수의 주문 공격을 활성화합니다."}
...
obj["NOTIFICATION_SOUL_SHARD_CREATED"]	= { label="영혼의 조각 생성", tooltip="영혼석 획득을 알려줍니다."}
...
obj["SWING_MISSED"]				= "근접 빗맞힘"
obj["RANGE_MISSED"]				= "원거리 빗맞힘"
obj["SPELL_MISSED"]				= "주문 빗맞힘"
obj["GENERIC_MISSED"]			= "빗맞힘 (적중하지 않음)"
obj["SPELL_PERIODIC_MISSED"]	= "주기적인 주문 빗맞힘"
obj["SPELL_DISPEL_FAILED"]		= "주문 해제 실패"
obj["DAMAGE_SHIELD_MISSED"]		= "피해막 빗맞힘"
obj["SPELL_HEAL"]				= "치유"
...
obj["UNIT_MANA"]				= "마나 변화"
obj["UNIT_ENERGY"]				= "기력 변화"
obj["UNIT_RAGE"]				= "분노 변화"
obj["UNIT_RUNIC_POWER"]			= "룬 마력 변화"
obj["SKILL_COOLDOWN"]			= "재사용 대기시간 종료"
